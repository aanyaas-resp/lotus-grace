...
const buttonVariants = cva(
  "group inline-flex items-center justify-center gap-2 rounded-[12px] px-space-md py-4 text-sm font-semibold uppercase tracking-[0.1em] transition-all duration-300",
  {
    variants: {
      variant: {
        primary:
